"""Tutorial endpoints (POST /tutorial/*) – PLACEHOLDER."""
...
async def tutorial_fallback(
    ...
    logger.debug("Unimplemented tutorial endpoint: /tutorial/%s", path)
    if not settings.legacy_compatibility_mode:
        return _not_implemented(f"/tutorial/{path}", headers)
