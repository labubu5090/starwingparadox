...
OUT = r"C:\Users\KAHO\Pictures\Starwing\tools\ida_g21\out\g77c_equipcustomize.json"
...
try:
    ...
    for ea, name in idautils.Names():
        ...
        if ("playerprofilework" in low and ("equip" in low or "customize" in low or "robot" in low or "mechaset" in low)) \
           or "getequipplayercustomize" in low:
